...
class SavedRequestAwareWrapper extends HttpServletRequestWrapper {
	...
	protected static final Log logger = LogFactory
			.getLog(SavedRequestAwareWrapper.class);
	...
	public SavedRequestAwareWrapper(SavedRequest saved,
	 ...
	 * <p>
	 * If the value from the wrapped request is null, an attempt will be made to
	 * retrieve the parameter from the saved request.
	 */
	@Override
	...
	public String[] getParameterValues(String name) {
		...
		// We have parameters in both saved and wrapped requests so have to
		// merge them
		...
		// We want to add all parameters of the saved request *apart from*
		// duplicates of those already added
